...
const Hero: React.FC = () => {
  ...
  return (
    <div id="home" className="relative bg-cigre-green h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      {/* Overlay suave para legibilidade do texto, sem esconder a arte do banner */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent z-10"></div>
      
      {/* Last Updated Tag */}
      <div className="absolute top-24 right-4 md:right-8 z-20">
        <span className="text-[10px] md:text-xs text-white/70 bg-black/40 px-2 py-1 rounded backdrop-blur-md border border-white/10">
      ...
      <div className="relative z-20 text-center px-4 max-w-5xl mx-auto drop-shadow-2xl">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-white mb-10 text-lg font-medium">
